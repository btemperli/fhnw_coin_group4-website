...
function App() {
    ...
    var containerErwerb = $('#container-erwerb');
    var containerStudent = $('#container-student');

    var reflow = function () {
        chartErwerb = containerErwerb.highcharts();
        chartStudent = containerStudent.highcharts();
        chartErwerb.reflow();
        chartStudent.reflow();
    };
